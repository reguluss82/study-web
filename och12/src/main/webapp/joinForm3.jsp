		...
		<table border="1">
			<tr>
				...
				<td>
					...
					<input type="button" value="아이디체크" onclick="winop()">
				</td>
			</tr>
			<tr>
				<td>암호</td>
			...
			<tr>
				<td>전화번호</td>
				<td>
					<input type="tel" name="tel" required="required" pattern="\d{2,3}-\d{3,4}-\d{4}" 
					placeholder="010-xxxx-xxxx" title="2,3자리-3,4자리-4자리"> <!-- title : 마우스 갖다대면 뜨는 text -->
				</td>
			</tr>
			<tr>
				<td>회원Image</td>
				<td>
					<input type="file" name="img_path" required="required">
				</td>
			</tr>
			<tr>
				<td>
